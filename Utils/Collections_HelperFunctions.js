 ...
 */
function excluceBasedOnRemarks(lastRequest, todayDay, machineName = null) {
  try {
 ...
 */
function excludeNotYetScheduled(machineName, tomorrowDateString, lastRemark) {
  // Configuration
  ...
  const collectionDate = new Date(`${tomorrowDateString}, ${currentYear}`);
...
function excludeRequestedYesterday(previouslyRequestedMachines, machineName, srvBank) {
...
function excludeHolidayCollection(machineName, collectionSchedule, isTomorrowHoliday) {
